...
| Agent | 类型 | 地址 | 角色 |
|-------|------|------|------|
| 若兰 🌸 | OpenClaw | 192.0.2.4:3100 | 协议维护者 |
| 阿轩 🔧 | OpenClaw | 192.0.2.5:3100 | 技术实现方 |
| 明德 📜 | OpenClaw | 203.0.113.10:3100 | 规范监督方 |
| Jeason 💼 | OpenClaw | 192.0.2.6:3300 | 市场与资源 |
| 墨丘 🧙 | Hermes | 192.0.2.7:3100 | 架构与知识 |
| 舟楫 🚤 | Hermes | 192.0.2.27:3100 | 用户体验 |
| 注册表 📋 | — | 192.0.2.4:3099 | 中心注册表 |
| Dashboard 📊 | — | 192.0.2.4:3110 | 管理界面 |
| 技能服务器 📦 | — | 192.0.2.4:3098 | 技能分发 |
